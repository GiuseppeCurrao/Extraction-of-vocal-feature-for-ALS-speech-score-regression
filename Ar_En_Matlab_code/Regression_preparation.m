...
save(fullfile(code_folder, "Data/pa_regr.mat"),"ID","label","ar_pa","af_pa","slp");
%%
...
save(fullfile(code_folder, "Data/pa_th_regr.mat"),"ID","label","ar_th_pa","af_th_pa","slp");
...
save(fullfile(code_folder, "Data/pataka_regr.mat"),"ID", "label","ar_ptk","af_ptk","slp");
%%
[count_hc, count_sla] = count_csv(csv_hc_th, csv_sla_th);
slp = {};
sum = 1;
...
save(fullfile(code_folder, "Data/pataka_th_regr.mat"),"ID","label","ar_th_ptk","af_th_ptk","slp");
%% Dataset preparation for both syllables
% Since both PA and PATAKA files are taken from the same patients, it is
% possible to combine them
slp_pa=load("Data\pa_regr.mat", 'slp');
slp_pa=slp_pa.slp;

slp_ptk=load("Data\pataka_regr.mat", 'slp');
slp_ptk=slp_ptk.slp;
%%
slp = {};
for i=1:19
    slp{i}=(slp_pa{i}+slp_ptk{i})/2;
end

save(fullfile(code_folder, "Data/syllables_regr.mat"),"ID","label","ar_pa","af_pa","ar_ptk","af_ptk","slp");
save(fullfile(code_folder, "Data/syllables_th_regr.mat"),"ID","label","ar_th_pa","af_th_pa","ar_th_ptk","af_th_ptk","slp");
%%
